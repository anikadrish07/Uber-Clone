    ...
    <div>
        ...
        <h3 className='text-xl font-semibold mb-5'>Choose a vehicle</h3>
          ...
          <div
              ...
              <img className='h-15' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1GH_1MoFhFiPLon-4Zh79ac_lTOYHU8b3Bwr04wie-_3suaeWXfPXmm5kjbUFWiZWWV8&usqp=CAU" alt="" />
              <div className='w-1/2'>
                  <h4 className='font-medium text-sm'>UberGo <span><i className="ri-user-fill"></i>4</span></h4>
                  <h5 className='font-medium text-sm'>2 mins away</h5>
                  <p className='font-normal text-xs text-gray-600'>Affordable, compact rides</p>
              </div>
              <h2 className='text-lg'>₹190.79</h2>
          </div>

...
const FinishRide = (props) => {
    ...
    return (
        <div >
            ...
            <div className='flex items-center justify-between p-4 border-2 rounded-lg border-yellow-400 mt-4'>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-10 w-full'>
                    <button
                        onClick={endRide}
                        className='w-full mt-5 flex text-lg justify-center bg-yellow-500 text-black font-semibold p-3 rounded-lg'>Finish Ride</button>
                </div>
            </div>
        </div>
    )

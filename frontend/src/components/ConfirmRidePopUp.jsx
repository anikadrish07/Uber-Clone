...
const ConfirmRidePopUp = (props) => {
    ...
    return (
        <div >
            ...
            <h3 className='text-xl font-semibold mb-5'>Confirm the Ride to Start</h3>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-6 w-full'>
                    <form onSubmit={submitHandel}>
                        ...
                        <button className='w-full mt-5 text-lg flex justify-center bg-yellow-500 text-black font-semibold p-3 rounded-lg'>Confirm</button>
